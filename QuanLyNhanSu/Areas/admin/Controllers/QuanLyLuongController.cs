...
namespace QuanLyNhanSu.Areas.admin.Controllers
{
    ...
    //     public class QuanLyLuongController : AuthorController
    {
        ...
        public ActionResult GetLuongByMonth(int month)
        {
            var luongList = db.ChiTietLuongs.Where(l => l.NgayNhanLuong.Month == month).ToList();
            return PartialView("_LuongTable", luongList);
        }
        [HttpGet]
        ...
        public ActionResult ThanhToanLuong()
        {
            ...
            foreach (var item in luong)
            {
                ...
                if (ctl == null || (ctl != null && ctl.NgayNhanLuong != ct.NgayNhanLuong))
                {
        ...
        public ActionResult XuatFileLuong(String id)
        {
            ...
            dt.Columns.Add("Tiền thưởng", typeof(String));
            dt.Columns.Add("Tiền phạt", typeof(String));
            ...
            foreach (var item in ds)
            {
                ...
                newRow["Tiền thưởng"] = item.TienThuong;
                newRow["Tiền phạt"] = item.TienPhat;
